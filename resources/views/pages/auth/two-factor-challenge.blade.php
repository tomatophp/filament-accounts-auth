...
new class extends Component
{
    ...
    public function submitCode($code)
    {
        ...
        $user = \Devdojo\Auth\Helper::accountModel()::find(session()->get('login.id'));
    ...
    public function loginUser($user){
        ...
        event(new Login(auth()->guard('accounts'), $user, true));
...
<x-auth::layouts.app title="{{ \Devdojo\Auth\Helper::language('twoFactorChallenge.page_title') }}">
